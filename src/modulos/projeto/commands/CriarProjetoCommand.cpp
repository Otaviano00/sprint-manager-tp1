...
CriarProjetoCommand::CriarProjetoCommand(IProjetoService *service) : ProjetoCommand(service) {}

void CriarProjetoCommand::executar()
{
    Projeto projeto;
    ...
    {
        throw std::invalid_argument("Erro ao criar projeto: " + std::string(e.what()));
    }
